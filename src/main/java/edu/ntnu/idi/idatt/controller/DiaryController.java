 ...
 * Handles viewing and managing diary entries.
 */
public class DiaryController {
    ...
    public Action showEntriesMenu(Scanner in, PrintStream out) {
        ...
        while (true) {
            ...
            switch (choice) {
                case "1" -> { return (in2, out2) -> listAllEntries(in2, out2); }
                case "2" -> { return (in2, out2) -> createEntry(in2, out2); }
                case "3" -> { return (in2, out2) -> searchEntries(in2, out2); }
     ...
     * @return the next action to execute
     */
    public Action showEntryDetail(DiaryEntry entry, Action backDestination, Scanner in, PrintStream out) {
        ...
        while (true) {
            ...
            switch (choice) {
                case "1" -> { return (in2, out2) -> editEntry(entry, backDestination, in2, out2); }
                case "2" -> { return (in2, out2) -> deleteEntry(entry, backDestination, in2, out2); }
     ...
     * @return the next action to execute
     */
    private Action deleteEntry(DiaryEntry entry, Action backDestination, Scanner in, PrintStream out) {
