...
/**
 * Router that executes the action-based TUI loop. Continues executing actions until one returns
 * null.
 */
public class Router {
  ...
  /**
   * Runs the main application loop. Executes actions until one returns null.
   */
  public void run() {
